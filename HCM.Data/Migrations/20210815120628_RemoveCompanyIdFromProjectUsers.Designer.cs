...
namespace HCM.Data.Migrations
{
    ...
    [Migration("20210815120628_RemoveCompanyIdFromProjectUsers")]
    partial class RemoveCompanyIdFromProjectUsers
    {
            ...
            modelBuilder.Entity("HCM.Data.Models.RequestedLeave", b =>
                {
                    ...
                    b.Property<string>("RevisedByManagerId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HCM.Data.Models.RequestedLeave", b =>
                {
                    ...
                    b.HasOne("HCM.Data.Models.User", "RevisedByManager")
                        .WithMany()
                        .HasForeignKey("RevisedByManagerId");

                    b.Navigation("RequestedByUser");

                    b.Navigation("RevisedByManager");
                });
